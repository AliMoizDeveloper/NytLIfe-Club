...
import {ImageString, ScreenHeight1, ScreenWidth1} from '../../../constant/Constants';
...
const data = [
  ...
  {
    id: '3',
    imgAvatar: ImageString.Club_DashBoard_BackImage, // Provide the actual image path
...
const BookingList = () => {
  const renderItem = ({ item }) => (
    <BookingRequestCard
      ...
      // buttonText2={'Delete'}
      // isRightBtn={true}
      WidthBtn1={ScreenWidth1(0.5)}
      // WidthBtn2={resWidth(100)}
      buttonpad1={ScreenHeight1(0.008)}
